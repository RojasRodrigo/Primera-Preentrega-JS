...
const precioUnidad = 7.00;
const descuentoMediaDocena = 0.10;
const descuentoDocena = 0.15;
const cantidadDeOpciones = 6;

const listaSabores = [
    new Empanada(' Empanada de Pollo'),
    new Empanada('Empanada de Carne'),
    new Empanada('Empanada de Jamon'),
    new Empanada('Empanada de Huevo'),
    new Empanada('Empanada Picante'),
    new Empanada('Empanada de Queso con Jamon y Aceitunas'),
];
...
const promocionesBancarias = [
    ...
    new PromoBancaria('Banco Union', 0.10),
];
...
- Llevando 6 o más ${descuentoMediaDocena * 100}% de descuento.
